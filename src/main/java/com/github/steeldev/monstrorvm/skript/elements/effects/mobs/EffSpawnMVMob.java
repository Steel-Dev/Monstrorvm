...
public class EffSpawnMVMob extends Effect {

    static {
        Skript.registerEffect(EffSpawnMVMob.class, "spawn mvmob %mvmob% at %location%");
    }
    ...
    protected void execute(Event event) {
        ...
        EffSpawn.lastSpawned = m.spawnMob(l, null);
    }
